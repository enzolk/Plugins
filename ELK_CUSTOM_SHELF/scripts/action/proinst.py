# ELK_META {"label": "Rename Freeze Instance", "short_name": "RenFrz", "tooltip": "Renomme automatiquement des instances et applique des opérations de cleanup.", "source": "python", "icon_svg": "writing.svg", "icon_color": "#c678ff"}
