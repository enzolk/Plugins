# ELK_META {"label": "Select Edges By Area", "short_name": "AreaEd", "tooltip": "Sélectionne les edges selon la taille et l’aire des faces adjacentes.", "source": "python", "icon_svg": "chart-area.svg", "icon_color": "#c678ff"}
