# ELK_META {"label": "Quick Curve Point Insert", "short_name": "CVAdd", "tooltip": "Ajoute rapidement des points sur une courbe NURBS sélectionnée.", "source": "python", "icon_svg": "point.svg", "icon_color": "#36d6ff"}
