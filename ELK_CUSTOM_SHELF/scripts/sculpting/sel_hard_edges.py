# ELK_META {"label": "Select Hard Edges", "short_name": "HardEg", "tooltip": "Sélectionne les hard edges d’un mesh.", "source": "python", "icon_svg": "border-outer.svg", "icon_color": "#ff5c8a"}
