# ELK_META {"label": "Apply Edge Crease", "short_name": "Crease", "tooltip": "Applique un crease sur les edges sélectionnées.", "source": "python", "icon_svg": "corner-down-right-double.svg", "icon_color": "#ff5c8a"}
