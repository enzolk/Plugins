...
class Category(QtWidgets.QFrame):
    ...
    def build(self):
        ...
        h=QtWidgets.QHBoxLayout(self.header); h.setContentsMargins(10,8,10,8); h.setSpacing(8); h.addWidget(SvgIconWidget(self.icon_svg, self.icon_color or self.color, max(8, int(round(16 * icon_scale)))))
        self.title=QtWidgets.QLabel(self.name.upper()); self.title.setStyleSheet("background:transparent;color:%s;font-weight:800;font-size:%dpx;border:0px;"%(TEXT, max(7, int(round(12 * text_scale))))); h.addWidget(self.title,1)
        self.count_label=QtWidgets.QLabel(str(len(self.items))); self.count_label.setStyleSheet("background:transparent;color:%s;font-size:%dpx;border:0px;"%(MUTED, max(7, int(round(11 * text_scale))))); h.addWidget(self.count_label)
        ...
        ch.addWidget(SvgIconWidget(self.icon_svg, self.icon_color or self.color, max(8, int(round(17 * icon_scale)))),0,QtCore.Qt.AlignHCenter)
        self.collapsed_title=VerticalTextLabel(self.name.upper(), TEXT, scale=text_scale)
