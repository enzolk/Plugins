...
UI_COLOR_BG_STEP_CARD = (0.15, 0.19, 0.27)
UI_COLOR_BG_STEP_SURFACE = (0.17, 0.22, 0.30)
UI_COLOR_BG_STEP_INPUT = (0.08, 0.10, 0.15)
UI_COLOR_BG_STEP_PRIMARY = (0.19, 0.36, 0.71)
...
class HighPolyReviewTool:
    ...
    def _build_placeholder_step_card(self) -> None:
        ...
        cmds.text(label="STEP", align="center", height=12)
        cmds.text(label="01", align="center", height=20)
        cmds.setParent("..")
        cmds.setParent("..")
        cmds.text(label="Placeholder Match", align="left", font="boldLabelFont", height=26)
        cmds.text(label="ⓘ", align="left", height=26)
    ...
    def _build_placeholder_checks_actions_row(self) -> None:
        ...
        cmds.rowLayout(numberOfColumns=2, columnAttach=[(1, "both", 0), (2, "both", 28)])
        ...
        cmds.setParent("..")
        cmds.separator(style="single", width=1, height=34)
        cmds.rowLayout(
            numberOfColumns=3,
            adjustableColumn=1,
        ...
        cmds.iconTextButton(style="textOnly", label="▶  Run Placeholder Check", height=32, backgroundColor=UI_COLOR_BG_STEP_PRIMARY, command=lambda *_: self.check_placeholder_match())
