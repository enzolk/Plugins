...
def show_outsource_review_tool() -> HighPolyReviewTool:
    ...
    if _QT_WINDOW_INSTANCE and QtWidgets:
        try:
            _QT_WINDOW_INSTANCE.close()
            _QT_WINDOW_INSTANCE.deleteLater()
        except Exception:
            pass
        _QT_WINDOW_INSTANCE = None
    ...
    if QtWidgets and QtCore:
        ...
        _QT_WINDOW_INSTANCE.setAttribute(QtCore.Qt.WA_DeleteOnClose, False)
        _QT_WINDOW_INSTANCE.show()
        _QT_WINDOW_INSTANCE.raise_()
        _QT_WINDOW_INSTANCE.activateWindow()
    else:
